#We create a database using phpmyadmin#
...
#We use a php file to connect to the database (phpmyadmin)#
-------------------------------------------------------------------------------------

Questions2: insérer les données dans la base. 

#We use a php file to import data from the CSV file, don't forget to put the CSV file in the htdoc folder inside the folder containing the used php files.#
-------------------------------------------------------------------------------------
Questions3: modifier la table modele en ajoutant les attributs ( prix, couleur et 
